...
cef_content_setting_types_t ToCefType(ContentSettingsType type) {
  switch (type) {
    ...
    TO_CEF_TYPE(PERSISTENT_STORAGE);
    ...
    TO_CEF_TYPE(LOCAL_NETWORK);
    TO_CEF_TYPE(LOOPBACK_NETWORK);
    case ContentSettingsType::DEPRECATED_SUB_APP_INSTALLATION_PROMPTS:
      return CEF_CONTENT_SETTING_TYPE_SUB_APP_INSTALLATION_PROMPTS_DEPRECATED;
...
std::optional<ContentSettingsType> FromCefType(
  ...
  switch (type) {
    ...
    FROM_CEF_TYPE(PERSISTENT_STORAGE);
    ...
    FROM_CEF_TYPE_DEPRECATED(THIRD_PARTY_STORAGE_PARTITIONING);
    ...
    FROM_CEF_TYPE_DEPRECATED(TPCD_TRIAL);
    FROM_CEF_TYPE_DEPRECATED(TOP_LEVEL_TPCD_TRIAL);
    FROM_CEF_TYPE_DEPRECATED(TOP_LEVEL_TPCD_ORIGIN_TRIAL);
    ...
    FROM_CEF_TYPE_DEPRECATED(SUB_APP_INSTALLATION_PROMPTS);
    ...
    FROM_CEF_TYPE_DEPRECATED(TRACKING_PROTECTION);
